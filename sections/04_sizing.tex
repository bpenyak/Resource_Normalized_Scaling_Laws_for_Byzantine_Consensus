...
detection constraint. Any detector yielding measured $(\pd,\pf,\rho)$ plugs in;
X5 is one instance.
...
$\neff=\kf\w/(1+(\kf-1)\rho)$. With X5 rates (AUC$\,=\,\resAuc$), the campaign
defaults to the throughput-bound constraint.
...
\cite{charnes1959,nemirovski2007}; within the proposed framework it converts
calibrated exponents into a sizing rule for the investigated deployment class.
