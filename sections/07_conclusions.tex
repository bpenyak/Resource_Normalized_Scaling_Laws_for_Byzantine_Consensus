...
commodity machine. \emph{Third}, calibrated lognormal prediction intervals,
...
$[\nmin,\nmax]$ computable in $O(\log\n)$ evaluations; the detection bound
itself is standard, and what it contributes is a constraint monotone in the
