...
bi-factor model and stated path assumptions. Its engineering value is
interpretive: discrepant single-factor exponents can arise from the concurrency
schedule. Section~\ref{sec:exp} checks consistency within the evaluated
