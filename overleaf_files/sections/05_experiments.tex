...
\begin{figure}[!t]
\centering
\includegraphics[width=0.38\textwidth]{figures/fig_confounding}
...
$\resBetaRttHigh$ in this campaign. Sizing rules calibrated on LAN-like RTT are
...
\begin{figure}[!t]
\centering
\includegraphics[width=0.36\textwidth]{figures/fig_roc}
